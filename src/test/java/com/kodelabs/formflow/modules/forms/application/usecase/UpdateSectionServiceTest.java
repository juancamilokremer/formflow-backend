...
class UpdateSectionServiceTest {
    ...
    void updatesTitleAndDescription() {
        ...
        SectionResult result = service.execute(new UpdateSectionCommand(sectionId, formId, tenantId, "Nuevo", "Desc"));
    ...
    void throwsNotFoundWhenSectionDoesNotExist() {
        ...
        assertThatThrownBy(() -> service.execute(
                new UpdateSectionCommand(sectionId, formId, tenantId, "T", null)))
